# Aparecida - Distributed Identification System for Missing Children
...
*The data used in the showcase examples was sampled from the Microsoft DigiFace-1M Dataset. The original dataset can be found [here](https://github.com/microsoft/DigiFace1M).*